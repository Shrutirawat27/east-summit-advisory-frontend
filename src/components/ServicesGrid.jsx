...
const ServicesGrid = ({ isHome }) => {
  ...
  const servicesList = [
    ...
    },
    {
      ...
      shortDesc: "Rigorous oversight ensuring precision and regulatory adherence.",
      details: "Our audit services provide an intensive examination of your records and financial statements. We ensure the highest level of assurance to third parties."
    },
    {
      id: "Advisory",
      icon: <Icons.Advisory />,
    ...
    },
    {
      ...
      shortDesc: "Deep-dive investigations to uncover financial discrepancies.",
      details: "When numbers don't add up, we dig deeper. Our forensic accounting services investigate financial discrepancies, fraud, or disputes."
    }
  ];
